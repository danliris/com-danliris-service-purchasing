...
namespace Com.DanLiris.Service.Purchasing.Test.Facades.GarmentDeliveryOrderTests
{
    public class MonitoringTest
    {
        ...
        [Fact]
        public async Task Should_Success_GetReport_DebtBalance()
        {
            var httpClientService = new Mock<IHttpClientService>();
            httpClientService.Setup(x => x.GetAsync(It.Is<string>(s => s.Contains("master/garment-suppliers"))))
                .ReturnsAsync(new HttpResponseMessage(HttpStatusCode.OK) { Content = new StringContent(new SupplierDataUtil().GetResultFormatterOkString()) });
            ...
            var facade = new GarmentDeliveryOrderFacade(serviceProviderMock.Object, dbContext);
            ...
            var dataDo = await dataUtilDo.GetTestData();
            var dataEPO = await datautilexpo.GetTestData();
            ...
            var facadedebbalance = new GarmentDebtBalanceReportFacade(serviceProviderMock.Object, dbContext, mockDbContext.Object);
            var Response = facadedebbalance.GetReport(It.IsAny<bool>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<DateTime>(), It.IsAny<DateTime>(), "{}", 7);
            Assert.NotNull(Response.ToArray());
        }

        [Fact]
        public async Task Should_Success_Get_Xls_DebtBalance()
        {
            var httpClientService = new Mock<IHttpClientService>();
            httpClientService.Setup(x => x.GetAsync(It.Is<string>(s => s.Contains("master/garment-suppliers"))))
                .ReturnsAsync(new HttpResponseMessage(HttpStatusCode.OK) { Content = new StringContent(new SupplierDataUtil().GetResultFormatterOkString()) });
            ...
            var facadedebbalance = new GarmentDebtBalanceReportFacade(serviceProviderMock.Object, dbContext, mockDbContext.Object);
            var Response = facadedebbalance.GetXLs(It.IsAny<bool>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<DateTime>(), It.IsAny<DateTime>(), 7);
            Assert.IsType<System.IO.MemoryStream>(Response);
        }

        [Fact]
        public async Task Should_Success_Get_Xls_DebtBalance_Null_Parameter()
        {
            var httpClientService = new Mock<IHttpClientService>();
            httpClientService.Setup(x => x.GetAsync(It.Is<string>(s => s.Contains("master/garment-suppliers"))))
                .ReturnsAsync(new HttpResponseMessage(HttpStatusCode.OK) { Content = new StringContent(new SupplierDataUtil().GetResultFormatterOkString()) });
        ...
        [Fact]
        public async Task Should_Error_GetReport_DebtBalance()
        {
            var httpClientService = new Mock<IHttpClientService>();
            httpClientService.Setup(x => x.GetAsync(It.Is<string>(s => s.Contains("master/garment-suppliers"))))
                .ReturnsAsync(new HttpResponseMessage(HttpStatusCode.OK) { Content = new StringContent(new SupplierDataUtil().GetResultFormatterOkString()) });
        ...
        [Fact]
        public async Task Should_Error_Get_Xls_DebtBalance()
        {
            var httpClientService = new Mock<IHttpClientService>();
            httpClientService.Setup(x => x.GetAsync(It.Is<string>(s => s.Contains("master/garment-suppliers"))))
                .ReturnsAsync(new HttpResponseMessage(HttpStatusCode.OK) { Content = new StringContent(new SupplierDataUtil().GetResultFormatterOkString()) });
