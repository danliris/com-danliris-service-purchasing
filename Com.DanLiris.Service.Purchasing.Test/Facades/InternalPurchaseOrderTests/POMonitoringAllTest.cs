...
namespace Com.DanLiris.Service.Purchasing.Test.Facades.InternalPurchaseOrderTests
{
    ...
    public class POMonitoringAllTest
    {
        ...
        public async Task Should_Success_Get_Report_Data()
        {
            ...
            var Response = Facade.GetReport(model.PRNo, null, model.UnitId, model.DivisionCode, model.CategoryId, null, null, model.CreatedBy, null, null, null, 1, 25, "{}", 7, "");
        ...
        {
            InternalPurchaseOrder model = await DataUtil.GetTestData("Unit test");
            var Response = Facade.GenerateExcel(model.PRNo, null, model.UnitId, model.DivisionCode, model.CategoryId, null, null, model.CreatedBy, null, null, null, 7,"");
