...
namespace Com.DanLiris.Service.Purchasing.Test.Controllers.GarmentReport
{
    public class GarmentFlowDetailMaterialControllerTest
    {
        ...
        {
            var mockFacade = new Mock<IGarmentFlowDetailMaterialReport>();
            mockFacade.Setup(x => x.GenerateExcel(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<DateTimeOffset>(), It.IsAny<DateTimeOffset>(), It.IsAny<int>()))
            ...
            var response = controller.GetXls(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<DateTimeOffset>(), It.IsAny<DateTimeOffset>(), It.IsAny<int>(), It.IsAny<int>(), It.IsAny<string>());
