...
namespace Com.DanLiris.Service.Purchasing.Test.Controllers.GarmentUnitReceiptNoteControllerTests
{
    public class GarmentUnitReceiptNoteControllerTest
    {
        ...
        public void Should_Error_Get_Xls_All()
        {
            ...
            var response = controller.GetXls(It.IsAny<DateTime>(), It.IsAny<DateTime>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<int>(), It.IsAny<int>(), It.IsAny<string>());
            Assert.Equal((int)HttpStatusCode.InternalServerError, GetStatusCode(response));
        ...
        {
            var mockFacade = new Mock<IGarmentUnitReceiptNoteFacade>();
            mockFacade.Setup(x => x.GenerateExcelLow( It.IsAny<DateTime>(), It.IsAny<DateTime>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<int>(),It.IsAny<string>()))
                .Returns(new MemoryStream());
